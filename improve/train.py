...
import math
import os
os.environ["WANDB_API_KEY"] = 'e802ed6a23dda521dc8ea1624ed9df6cfc488479' # 将引号内的+替换成自己在wandb上的一串值
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/onlySPPAG.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / '1.yaml', help='dataset.yaml path')
